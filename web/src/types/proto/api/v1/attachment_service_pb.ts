...
export type Attachment = Message<"memos.api.v1.Attachment"> & {
  ...
  /**
   * Output only. Immich asset ID if this is an Immich attachment.
   *
   * @generated from field: string immich_asset_id = 9;
   */
